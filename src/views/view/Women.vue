<template>
  <div>
    ...
    <div class="row mt-5">
      ...
      v-for="item in WomenProduct" :key="item.id">
        <div class="card border-0" style="width: 222px;">
          <img :src="item.imageUrl" class="card-img-top" alt="product-img"
...
export default {
  ...
  methods: {
    ...
    ...mapActions('productsModules', ['getWomenProduct']),
  },
  computed: {
    ...mapGetters('productsModules', ['WomenProduct']),
  },
  created() {
    const vm = this;
    vm.getWomenProduct();
