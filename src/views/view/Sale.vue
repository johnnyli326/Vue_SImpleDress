<template>
  <div>
    ...
    <div class="row mt-5">
      ...
      v-for="item in SaleProduct" :key="item.id">
        <div class="card border-0" style="width: 222px;">
          <img :src="item.imageUrl" class="card-img-top" alt="product-img" style="height: 309.3px"
...
export default {
  ...
  methods: {
    ...
    ...mapActions('productsModules', ['getSaleProduct']),
  },
  computed: {
    ...mapGetters('productsModules', ['SaleProduct']),
  },
  created() {
    const vm = this;
    vm.getSaleProduct();
